  ...
  <script>
      ...
      <script>
        ...
        function ShowTables(str, dur, num) {
          ...
          xhttp.open("GET", "/BackEnd/Reservation/Main/CheckAvailability.php?time="+str+"&dur="+dur+"&number="+num, true);
          xhttp.send();
        }
                ...
                success: function(data)
                {
                    if(data == "PointLimit") {
                      ...
                      var seat = $(".radiocheck:checked").val(); 
                          ...
                          time = $('#time').val();
                      $.ajax({
                        url: "/BackEnd/Reservation/Main/Reserve.php",
                        type: "POST",
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a class="dropdown-item" href="/BackEnd/Login/logout.php">Log out</a>
              </div>
            </li>
          </ul>
          </div>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class='form-check seatSelector' id='table2'>  
                        <img src='/FrontEnd/IMG/seat2.png' style='width: 80px; height: 80px; pacity: 0.6;'>
                    </div>
