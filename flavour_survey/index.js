	...
	function displayCustomPage(personality) {
		switch (personality) {
			...
			case 0:	//cute code
				document.getElementById("results").innerHTML = '<h1> Rainbow Macaron </h1><p id="quiz">You\'re a cute person. We recommad you to\
																try out 7 rainbow color macarons\
																</p><br><br>\
																<p id="quiz">Made with Almond, Egg, Oats, Sugar</p>';
				break;
			...
			case 3:		//nerdy
				...
				document.getElementById("results").innerHTML = '<h1> Banana Protein Bomb Smoothie </h1><p id="quiz">You\'re a nerdy person. We recommad you to\
																have a sip of our signature smoothie\
																</p><br><br>\
																<p id="quiz">Made with Banada, Coconut Yoghurt, Oats, Organic Vegan Protein, Cinnamon.</p>';
				break;
				
			case 4:		//silly
				results.style.display = "inline-block";
				document.getElementById("results").innerHTML = '<h1> Chocolate Volcano Cake </h1><p id="quiz">You\'re a silly person. We recommad you to\
																try our volcano cake\
																</p><br><br>\
																<p id="quiz">Made with Mentos, Butter Cream, Milk, Chocolate Powder, Egg.</p>';
				break;
				
			case 5:		//cool
				document.getElementById("results").innerHTML = '<h1> Real Mojito </h1><p id="quiz">You\'re a cool person. We recommad you to\
																try our signature mojito drink\
																</p><br><br>\
																<p id="quiz">Made with Mint leaves, Lime, Water.</p>';
				break;
